...
#else
#define SERVERLIST_TOTALSIZE		256
#endif
...
#ifndef REDUCE_MEMORY
#define SERVERLIST_INFO_NAME_LEN 128
#else
#define SERVERLIST_INFO_NAME_LEN 64
#endif
...
typedef struct serverlist_info_s
{
	...
	char cname[SERVERLIST_INFO_NAME_LEN];
	...
	char map[32];
	// name of the session
	char name[SERVERLIST_INFO_NAME_LEN];
	// max client number
	int maxplayers;
...
#ifndef REDUCE_MEMORY
#define SERVERLIST_ENTRY_LINE_LEN 128
#else
#define SERVERLIST_ENTRY_LINE_LEN 32
#endif
...
typedef struct serverlist_entry_s
{
	...
	// legacy stuff
	char line1[SERVERLIST_ENTRY_LINE_LEN];
	char line2[SERVERLIST_ENTRY_LINE_LEN];
} serverlist_entry_t;
