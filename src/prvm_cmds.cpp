...
void VM_vectoangles (void)
{
	...
	else
	{
		...
		forward = dr_sqrt(value1[0]*value1[0] + value1[1]*value1[1]);
		pitch = (dr_atan2(value1[2], forward) * 180 / M_PI);
		if (pitch < 0)
			pitch += 360;
	}
...
void VM_fabs (void)
{
	...
	v = PRVM_G_FLOAT(OFS_PARM0);
	PRVM_G_FLOAT(OFS_RETURN) = dr_fabs(v);
}
...
void VM_rint (void)
{
	...
	if (f > 0)
		PRVM_G_FLOAT(OFS_RETURN) = dr_floor(f + 0.5);
	else
		PRVM_G_FLOAT(OFS_RETURN) = dr_ceil(f - 0.5);
}
...
void VM_floor (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_floor(PRVM_G_FLOAT(OFS_PARM0));
}
...
void VM_ceil (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_ceil(PRVM_G_FLOAT(OFS_PARM0));
}
...
void VM_sin (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_sin(PRVM_G_FLOAT(OFS_PARM0));
}
...
void VM_cos (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_cos(PRVM_G_FLOAT(OFS_PARM0));
}
...
void VM_sqrt (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_sqrt(PRVM_G_FLOAT(OFS_PARM0));
}
...
void VM_asin (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_asin(PRVM_G_FLOAT(OFS_PARM0));
}
...
void VM_acos (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_acos(PRVM_G_FLOAT(OFS_PARM0));
}
...
void VM_atan (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_atan(PRVM_G_FLOAT(OFS_PARM0));
}
...
void VM_atan2 (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_atan2(PRVM_G_FLOAT(OFS_PARM0), PRVM_G_FLOAT(OFS_PARM1));
}
...
void VM_tan (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_tan(PRVM_G_FLOAT(OFS_PARM0));
}
...
void VM_pow (void)
{
	...
	PRVM_G_FLOAT(OFS_RETURN) = dr_pow(PRVM_G_FLOAT(OFS_PARM0), PRVM_G_FLOAT(OFS_PARM1));
}
...
void VM_bitshift (void)
{
	...
	n1 = (int)dr_fabs((int)PRVM_G_FLOAT(OFS_PARM0));
