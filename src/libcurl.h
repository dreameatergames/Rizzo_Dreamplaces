...
#define Curl_Init()
#define Curl_Init_Commands()
#define Curl_Run()
#define Curl_Shutdown()
#define Curl_Have_forthismap() false
#define Curl_Register_predownload()
#define Curl_Clear_forthismap()
#define Curl_ClearRequirements()
#define Curl_SendRequirements()
#define Curl_RequireFile(FL)
