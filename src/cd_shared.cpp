...
#else
#define CDAudio_SysEject()
#define CDAudio_SysCloseDoor()
#define CDAudio_SysGetAudioDiskInfo() -1
#define CDAudio_SysGetVolume() -1.0f
#define CDAudio_SysSetVolume(VOL)
#define CDAudio_SysPlay(TRK) -1
#define CDAudio_SysStop() -1
#define CDAudio_SysPause() -1
#define CDAudio_SysResume() -1
#define CDAudio_SysUpdate() -1
#define CDAudio_SysInit()
#define CDAudio_SysStartup() -1
#define CDAudio_SysShutdown()
#endif
