...
#else
#define	PRVM_MAX_STACK_DEPTH		(512/2)
#define	PRVM_LOCALSTACK_SIZE		(4096/2)
#define PRVM_MAX_OPENFILES 		(128/2)
#define PRVM_MAX_OPENSEARCHES 		(64/2)
#endif
...
#else
#define PRVM_ERROR(FMT, RESTO...)	Host_ShutdownServer()
#endif
