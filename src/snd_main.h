...
#define SndSys_UnlockRenderBuffer()
#define SndSys_LockRenderBuffer() true
#define SndSys_GetSoundTime() 0
#define SndSys_Submit()
#define SndSys_Shutdown()
#define SndSys_Init(RQT,SG) false
#define Snd_AppendToSndBuffer(SB,SA,SF,FM) false
#define S_LockSfx(SF)
#define S_UnlockSfx(SF)
#define S_PaintChannels(RB,ST,ET)
