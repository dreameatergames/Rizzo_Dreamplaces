...
static void VM_CL_getlight (void)
{
	...
	if (cl.worldmodel && cl.worldmodel->t.brush.LightPoint)
		cl.worldmodel->t.brush.LightPoint(cl.worldmodel, p, ambientcolor, diffusecolor, diffusenormal);
	...
	*out = identitymatrix; // warnings and errors return identical matrix
	...
	{// RENDER_VIEWMODEL magic
		...
		if (ent->fields.client->health > 0 && cl_bob.value && cl_bobcycle.value)
		{
			...
			bob = dr_sqrt(ent->fields.client->velocity[0]*ent->fields.client->velocity[0] + ent->fields.client->velocity[1]*ent->fields.client->velocity[1])*cl_bob.value;
