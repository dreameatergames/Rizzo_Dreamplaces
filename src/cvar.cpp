...
#define MAX_CVAR_HASHTABLE 65536
#else
#define MAX_CVAR_HASHTABLE 4096
#endif

#define MAX_CVAR_HASHTABLE_MASK (MAX_CVAR_HASHTABLE-1)

static cvar_t *cvar_hashtable[MAX_CVAR_HASHTABLE];
...
cvar_t *Cvar_FindVar (const char *var_name)
{
	...
	hashindex = CRC_Block((const unsigned char *)var_name, strlen(var_name)) & MAX_CVAR_HASHTABLE_MASK;
...
// alphanumerical order
	...
	hashindex = CRC_Block((const unsigned char *)variable->name, strlen(variable->name)) & MAX_CVAR_HASHTABLE_MASK;
...
// alphanumerical order
	...
	// link to head of list in this hash table index
	hashindex = CRC_Block((const unsigned char *)cvar->name, strlen(cvar->name)) & MAX_CVAR_HASHTABLE_MASK;
