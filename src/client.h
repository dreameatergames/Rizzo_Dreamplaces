...
#define MAX_DLIGHTS (256 / REDUCE_DIVISOR_DLIGHTS)
...
#else
#define CL_StopPlayback() 
#define CL_ReadDemoMessage()
#define CL_WriteDemoMessage(M)
#endif
...
#ifndef REDUCE_MEMORY
#define WORLD_PVSBITS_MAX 32768
#else
#define WORLD_PVSBITS_MAX 2048
#endif
...
typedef struct r_viewcache_s
{
	...
	unsigned char world_pvsbits[(WORLD_PVSBITS_MAX+7)>>3];
	// TODO: dynamic resize according to r_refdef.worldmodel->brush.num_leafs
	unsigned char world_leafvisible[WORLD_PVSBITS_MAX];
	// TODO: dynamic resize according to r_refdef.worldmodel->num_surfaces
	unsigned char world_surfacevisible[WORLD_PVSBITS_MAX<<3];
